...
//修改后场地尺寸参数
const FieldDimensions FD_KIDSIZE{9.12, 6.12, 1.5, 2.6, 0.759, 2.12, 4.65, 1.1, 3.06};
const FieldDimensions FD_ADULTSIZE{14.12, 9.22, 2.242, 2.6, 1.53, 3.24, 6.1, 1.3, 4};
